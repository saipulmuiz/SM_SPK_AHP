...
// menghitung jumlah data pada table mhs untuk menentukan RC
    $data = mysqli_query($koneksi, "SELECT * FROM tb_alternatif ORDER BY id_alternatif");
                    ...
                    <div class="table-responsive">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Hasil Alternatif <?= $bk1["kriteria1"] ?>
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="text-transform: uppercase;"><?= $bk1["kriteria1"] ?></th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Hasil Alternatif <?= $bk2["kriteria1"] ?>
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="text-transform: uppercase;"><?= $bk2["kriteria1"] ?></th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Hasil Alternatif <?= $bk3["kriteria1"] ?>
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="text-transform: uppercase;"><?= $bk3["kriteria1"] ?></th>
                                                        <th><?php echo $b1['alternatif1']; ?></th>
                                                        <th><?php echo $b2['alternatif1']; ?></th>
                                                        <th><?php echo $b3['alternatif1']; ?></th>
                                                        <th><?php echo $b4['alternatif1']; ?></th>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Hasil Alternatif <?= $bk4["kriteria1"] ?>
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="text-transform: uppercase;"><?= $bk4["kriteria1"] ?></th>
                                                        <th><?php echo $b1['alternatif1']; ?></th>
                                                        <th><?php echo $b2['alternatif1']; ?></th>
                                                        <th><?php echo $b3['alternatif1']; ?></th>
                                                        <th><?php echo $b4['alternatif1']; ?></th>
